...
<form class="d-flex w-50" action="product?action=search" method="post" style="max-width: 500px; margin: auto;">
  <div class="input-group">
    ...
    <button class="btn btn-outline-light" type="submit" style="border-radius: 0 30px 30px 0; background-color: #007bff; border: 1px solid #007bff;">
    ...
    <div class="header-item">
      ...
      <div class="me-3">
        ...
        <% String username = (String) session.getAttribute("username"); Integer idtaikhoan = (Integer) session.getAttribute("idtaikhoan"); 
        if (username != null && idtaikhoan != null) { %>
          <span><%= username %></span> 
          <span class="text-white" style="margin-left: 10px;">|</span>
          <a href="thongtin?action=details&idtaikhoan=<%= idtaikhoan %>" class="text-white text-decoration-none mx-2">Thông tin tài khoản</a>
        <% } else { %>
