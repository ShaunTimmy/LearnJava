...
<body>
    <div class="success-box">
     ...
     <div class="payment-info">
         ...
         <p><strong>Số tài khoản:</strong> 1234 5678 9101</p>
         <p><strong>Chủ tài khoản:</strong> Shirley  </p>
         <p><strong>Thông tin chuyển tiền:</strong> Vui lòng chuyển khoản với mã đơn hàng cùng nội dung  <span class="order-id">
         <strong>Mã Đơn Hàng</strong></span> chuyển tiền đơn hàng   </p>
     </div>
     <br>
