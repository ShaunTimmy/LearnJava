...
<form action="sanpham?action=category" method="POST" class="cate p-2 shadow-sm w-50 w-md-30">
    <select class="form-select" name="searchCate" onchange="this.form.submit()">
        ...
        <div class="mb-3 d-flex flex-column flex-md-row justify-content-between align-items-center">
            ...
            <!-- Form tìm kiếm -->
           <div class="card p-2 shadow-sm w-50 w-md-30 border-0" style="position: relative; left: -20px;">
        ...
        <div class="d-flex justify-content-center mt-3">
            ...
            if (currentPage > 1) { %>
            <a href="sanpham?action=list&page=<%=currentPage - 1%>" class="btn btn-outline-primary mx-1">
