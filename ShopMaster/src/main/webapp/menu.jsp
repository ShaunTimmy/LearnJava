...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-body-tertiary">
		...
		: "")%>"
					...
					<li class="nav-item"><a class="nav-link <%=(request.getRequestURI().contains("cart") ? "active" : "")%>" href="cart?action=list"> <i
 ...
 %> <span
							class="badge badge-pill badge-danger <%=(soluong > 0 ? "changed" : "")%>">
								<%=soluong%>
						</span> 
						<%
 }
