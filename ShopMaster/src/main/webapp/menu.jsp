  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
     <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link <%= (request.getRequestURI().contains("dangky") ? "active" : "") %>" href="dangky"> <i class="fas fa-user"></i> Đăng Ký/Đăng Nhập </a></li>
                    <li class="nav-item"><a class="nav-link" href="#"> <i class="fas fa-shopping-cart"></i> Giỏ Hàng </a></li>
                       <li class="nav-item"><a class="nav-link <%= (request.getRequestURI().contains("wishlist") ? "active" : "") %>" href="wishlist?action=list"><i class="fas fa-heart"></i> Wishlist</a></li>
                    <li class="nav-item"><a class="nav-link <%= (request.getRequestURI().contains("lienhe") ? "active" : "") %>" href="lienhe"> <i class="fas fa-phone-alt"></i> Liên Hệ </a></li>
                </ul>
