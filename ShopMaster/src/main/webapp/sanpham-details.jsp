...
<body>
	...
	<section class="hero-section" style="background-color: #70a1ff; color: #fff;">
		<div class="container text-center">
			...
			<p>
				Khám phá thông tin chi tiết về sản phẩm, từ thiết kế, <br> tính năng đến giá cả, giúp bạn hiểu rõ hơn trước khi đưa ra lựa chọn mua sắm.
			</p>
		</div>
	</section>
		...
		<div class="row align-items-start">
			...
			<div class="col-md-6 col-lg-6 product-details-wrapper">
				...
				<div class="d-flex justify-content-start mt-3 gap-2">
					...
					<a href="#" class="btn btn-outline-info btn-sm">Xem Đánh Giá</a>
				</div>
			</div>
				<br> 
