...
<body>
	...
	<div class="content container py-5">
			...
			<div class="row mb-3">
				...
				<div class="col-md-6">
					<label for="thoigianGH" class="form-label">Thời Gian Giao
						Hàng</label> <select class="form-select" id="thoigianGH" name="thoigianGH">
		...
		&& ((Sanpham) request.getAttribute("sanpham")).getThoigianGH().equals("quick")) ? "selected" : ""%>>Ngày
			...
			<div class="mb-3">
				<label for="videoFile" class="form-label">Chọn Ảnh</label> <input
					type="file" class="form-control" id="videoFile" name="imgfile"
					accept="image/*" onchange="imgpreview(event)"> 
					<img id="previewImage" src="#" alt="Image Preview"
					style="display: none; margin-top: 10px; max-width: 160%; height: auto;" />
				<%
				if ("edit".equals(action)) {
				%>
				<p style="color: red;">Ảnh hiện tại sẽ được giữ nếu không tải
					ảnh mới.</p>
				<%
				}
				%>
