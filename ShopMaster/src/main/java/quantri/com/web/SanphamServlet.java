...
public class SanphamServlet extends HttpServlet {
	...
	private void searchByCategory(HttpServletRequest request, HttpServletResponse response) 
		...
		List<Sanpham> searchProduct=sanphamDao.ProuctByCate(searchCate);
		request.setAttribute("listSP", searchProduct);
		request.setAttribute("searchCate", searchCate);
		 request.setAttribute("selectedCate", searchCate); 
		RequestDispatcher dispatcher=request.getRequestDispatcher("search-list-by-cate.jsp");
		dispatcher.forward(request, response);
	}
	...
	private void listSP(HttpServletRequest request, HttpServletResponse response) 
		...
		request.getSession().setAttribute("tongsp", totalProduct);
